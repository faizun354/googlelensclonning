...
public class MainActivity extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = firebaseDatabase.getReference("SearchResults");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton imageToTextButton = findViewById(R.id.idBtnImageToText);
        imageToTextButton.setOnClickListener(view -> {
    ...
    private void searchData(String searchQuery) {
        ...
        String apiKey = "5fc9c1e9e072f8c2b97b34e24b076ae24ffcdc4d32e55eab96105bac00f40493";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < organicResultsArray.length(); i++) {
                        ...
                        DatabaseReference newRef = databaseReference.push(); // Generate unique ID
                        newRef.setValue(new dataModal(title, link, displayed_link, snippet))
